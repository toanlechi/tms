	...
	<div class="navbar-custom-menu">
		...
		<sec:authorize
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><sec:authorize
						access="hasRole('ROLE_1')">
						<a href='' class="dropdown-toggle" data-toggle="dropdown"> <img
							src="<c:url value="/static/images/avatar04.png" />"
							class="user-image" alt="User avatar"> <span
					...
					</sec:authorize> <sec:authorize access="hasRole('ROLE_2')">
						<a href='' class="dropdown-toggle" data-toggle="dropdown"> <img
						...
						<ul class="dropdown-menu">
							<li><a href="<c:url value="/trainingStaff/profile" />"><i
									class="fa fa-user fa-fw"></i> Profile</a></li>

							<li><a href="<c:url value="/logout" />"><i
									class="fa fa-sign-out fa-fw"></i> Logout</a></li>
						</ul>
					</sec:authorize> <sec:authorize access="hasRole('ROLE_3')">
						<a href='' class="dropdown-toggle" data-toggle="dropdown"> <img
					...
					</sec:authorize> <sec:authorize access="hasRole('ROLE_4')">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img
		...
		<sec:authorize access="!isAuthenticated()">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a
					href='<c:url value="/login" />' class="dropdown-toggle"
