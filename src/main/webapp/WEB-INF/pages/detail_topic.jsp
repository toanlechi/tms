<jsp:include page="templates/include_top.jsp">
	<jsp:param value="Detail Topic" name="title" />
</jsp:include>
<%--Begin Body --%>
			...
			<div class="row">
				<div class="col-xs-10 col-xs-offset-1">
					<p style="font-size: 18px; margin-left: 10px">
						Topic name: <a style="font-size: 20px">OOP</a>
					</p>
					<p style="font-size: 18px; margin-left: 10px">
						Courses name: <a href="detail_courses.html"
							style="font-size: 20px">Software Technologies</a>
					</p>
										...
										<table id="example2" class="table table-bordered table-hover">
											...
											<tbody>
												<tr>
													<td>1</td>
													<td>Toan</td>
													<td>description1escription1 description1</td>
													<td>
												...
												<tr>
													<td>2</td>
													<td>Tra</td>
													<td>description1descrption1 description1</td>
													<td>
														<div class="checkbox" style="margin-left: 30%;">
															<label> <input type="checkbox">
															</label>
												...
												<tr>
													<td>5</td>
													<td>Trainer5</td>
													<td>description1descriiption1 description1</td>
													<td>button</td>
												</tr>
												<tr>
													<td>6</td>
													<td>Trainer4</td>
													<td>description1description1 desn1 description1</td>
													<td>button</td>
												</tr>
												<tr>
													<td>7</td>
													<td>Trainer4</td>
													<td>description1descripdescription1 description1</td>
													<td>button</td>
												</tr>
												<tr>
													<td>8</td>
													<td>Trainer4</td>
													<td>description1description1 ption1 description1</td>
													<td>button</td>
												</tr>
												<tr>
													<td>9</td>
													<td>Trainer</td>
													<td>description1deescription1 description1</td>
													<td>button</td>
												</tr>
												<tr>
													<td>10</td>
													<td>Trainer</td>
													<td>description1desc description1 description1</td>
													<td>button</td>
												</tr>
												<tr>
													<td>11</td>
													<td>Trainer</td>
													<td>description1desescription1</td>
													<td>button</td>
												</tr>
